...
![TI CC2531]({static}/images/1*6_-biUkBycv6D2iKhXwm-Q.jpeg)
...
![TI CC-Debugger.]({static}/images/1*KCeo7QQRB5Rh5x4Vt0T3lQ.jpeg)
...
![Finding the transport key in the security header of a captured packet.]({static}/images/1*OxiKK5gPMCF5KMlTjyzCrA.png)

![Configuring the Zigbee keys in Wireshark preferences.]({static}/images/1*sMhGRmFwv0VZeh5Iw_hJYg.png)

Awesome! Now we get fully decrypted packets in Wireshark. So, what does it look like when I turn on a room?

![Interesting!]({static}/images/1*PYOaHRrHLnCKOczBRov-vg.png)
