...
![Cut2D logo]({static}/images/1*Oc0xv1koNSz8ktP5BR8TzQ.png)
...
![Layer 3 is actually invisible (the bulb should be grey). You can’t click on any of the bulbs or colour swatches.]({static}/images/1*Hjm-QGwFR252K32yRsF2xQ.png)
...
![Hello SysListView32! Note the XTP class names indicate they’re using [Exteme Toolkit Pro](http://www.codejock.com/products/toolkitpro/)]({static}/images/1*gbe7uhoDNfIv-dHmfBeCzg.png)
...
![Not much stuff happened.]({static}/images/1*YuHEQ-izMoe3OxrGZvQZcA.png)
...
![A lot more stuff happens!]({static}/images/1*M2HK0zmUR_MD6xXba0DCPQ.png)
...
git remote add jimmo [git
github.com](mailto:git
github.com):jimmo/wine.git### Step 4 -- Debugging
